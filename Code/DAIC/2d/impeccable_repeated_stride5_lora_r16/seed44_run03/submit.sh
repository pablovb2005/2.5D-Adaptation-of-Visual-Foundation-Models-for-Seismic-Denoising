...
#SBATCH --job-name=2d_s5_r16_s44_r03
...
#SBATCH --output=/home/nfs/pvarelabernal/RP/Code/DAIC/2d/impeccable_repeated_stride5_lora_r16/seed44_run03/slurm_%j.out
#SBATCH --error=/home/nfs/pvarelabernal/RP/Code/DAIC/2d/impeccable_repeated_stride5_lora_r16/seed44_run03/slurm_%j.err

set -euo pipefail

STUDENT_DIR=/tudelft.net/staff-bulk/ewi/insy/PRLab/Students/pvarelabernal
EXP_DIR=$STUDENT_DIR/experiments/runs/2d/impeccable_repeated_stride5_lora_r16/seed44_run03
CONFIG=configs/dinov3_vits_2d_impeccable_repeated_stride5_lora_r16_seed44_run03_daic.yaml
