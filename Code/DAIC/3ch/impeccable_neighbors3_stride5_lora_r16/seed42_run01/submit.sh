#!/bin/bash
# Image Impeccable true 2.5D 3-channel run.

#SBATCH --job-name=3ch_s5_r16_s42_r01
...
#SBATCH --output=/home/nfs/pvarelabernal/RP/Code/DAIC/3ch/impeccable_neighbors3_stride5_lora_r16/seed42_run01/slurm_%j.out
#SBATCH --error=/home/nfs/pvarelabernal/RP/Code/DAIC/3ch/impeccable_neighbors3_stride5_lora_r16/seed42_run01/slurm_%j.err

set -euo pipefail

STUDENT_DIR=/tudelft.net/staff-bulk/ewi/insy/PRLab/Students/pvarelabernal
EXP_DIR=$STUDENT_DIR/experiments/runs/3ch/impeccable_neighbors3_stride5_lora_r16/seed42_run01
CONFIG=configs/dinov3_vits_2d5_3ch_impeccable_neighbors3_stride5_lora_r16_seed42_run01_daic.yaml
