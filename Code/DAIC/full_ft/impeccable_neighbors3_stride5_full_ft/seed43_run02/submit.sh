#!/bin/bash
# Full fine-tuning baseline: all backbone params unfrozen, 3ch input, seed 43.

#SBATCH --job-name=full_ft_3ch_s43
...
#SBATCH --output=/home/nfs/pvarelabernal/RP/Code/DAIC/full_ft/impeccable_neighbors3_stride5_full_ft/seed43_run02/slurm_%j.out
#SBATCH --error=/home/nfs/pvarelabernal/RP/Code/DAIC/full_ft/impeccable_neighbors3_stride5_full_ft/seed43_run02/slurm_%j.err

set -euo pipefail

STUDENT_DIR=/tudelft.net/staff-bulk/ewi/insy/PRLab/Students/pvarelabernal
EXP_DIR=$STUDENT_DIR/experiments/runs/full_ft/impeccable_neighbors3_stride5_full_ft/seed43_run02
CONFIG=configs/dinov3_vits_full_ft_3ch_impeccable_neighbors3_stride5_seed43_run02_daic.yaml
...
echo "=== Starting training (3ch full fine-tuning, seed43) ==="
