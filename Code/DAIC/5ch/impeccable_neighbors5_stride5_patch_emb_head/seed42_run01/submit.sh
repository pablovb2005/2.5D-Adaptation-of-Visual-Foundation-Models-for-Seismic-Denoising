#!/bin/bash
# Image Impeccable 2.5D 5-channel PatchEmb + decoder-only run.

#SBATCH --job-name=5ch_ctrl_s5_s42_r01
...
#SBATCH --output=/home/nfs/pvarelabernal/RP/Code/DAIC/5ch/impeccable_neighbors5_stride5_patch_emb_head/seed42_run01/slurm_%j.out
#SBATCH --error=/home/nfs/pvarelabernal/RP/Code/DAIC/5ch/impeccable_neighbors5_stride5_patch_emb_head/seed42_run01/slurm_%j.err

set -euo pipefail

STUDENT_DIR=/tudelft.net/staff-bulk/ewi/insy/PRLab/Students/pvarelabernal
EXP_DIR=$STUDENT_DIR/experiments/runs/5ch/impeccable_neighbors5_stride5_patch_emb_head/seed42_run01
CONFIG=configs/dinov3_vits_2d5_5ch_impeccable_neighbors5_stride5_patch_emb_head_seed42_run01_daic.yaml
