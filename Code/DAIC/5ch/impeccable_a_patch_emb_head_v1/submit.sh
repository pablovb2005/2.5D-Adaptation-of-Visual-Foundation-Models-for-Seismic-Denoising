#!/bin/bash
#SBATCH --job-name=dinov3_5ch_a_v1
...
#SBATCH --output=/home/nfs/pvarelabernal/RP/Code/DAIC/5ch/impeccable_a_patch_emb_head_v1/slurm_%j.out
#SBATCH --error=/home/nfs/pvarelabernal/RP/Code/DAIC/5ch/impeccable_a_patch_emb_head_v1/slurm_%j.err

set -euo pipefail

STUDENT_DIR=/tudelft.net/staff-bulk/ewi/insy/PRLab/Students/pvarelabernal
EXP_DIR=$STUDENT_DIR/experiments/runs/5ch/impeccable_a_patch_emb_head_v1
...
# Create venv in /tmp — installs from local wheels (~2 min, no internet needed).
"$PY310" -m venv $VENV
...
srun python -u training/train.py --config configs/dinov3_vits_2d5_5ch_a_impeccable_daic.yaml
