#!/bin/bash
# Image Impeccable 2D repeated-channel baseline replicate.

#SBATCH --job-name=2d_s5_r16_s43_r02
...
#SBATCH --output=/home/nfs/pvarelabernal/RP/Code/DAIC/2d/impeccable_repeated_stride5_lora_r16/seed43_run02/slurm_%j.out
#SBATCH --error=/home/nfs/pvarelabernal/RP/Code/DAIC/2d/impeccable_repeated_stride5_lora_r16/seed43_run02/slurm_%j.err

set -euo pipefail

STUDENT_DIR=/tudelft.net/staff-bulk/ewi/insy/PRLab/Students/pvarelabernal
EXP_DIR=$STUDENT_DIR/experiments/runs/2d/impeccable_repeated_stride5_lora_r16/seed43_run02
CONFIG=configs/dinov3_vits_2d_impeccable_repeated_stride5_lora_r16_seed43_run02_daic.yaml
