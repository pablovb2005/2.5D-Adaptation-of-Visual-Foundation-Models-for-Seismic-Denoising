#!/bin/bash
# Main multi-data-seed reruns: 3 variants × 3 training seeds × 3 data seeds = 27 jobs.
#
...
#
# Submit all 27 jobs:
#   sbatch ~/RP/Code/DAIC/main_multidata/submit_main_multidata.sh
# Resubmit one job:
#   sbatch --array=<INDEX> ~/RP/Code/DAIC/main_multidata/submit_main_multidata.sh
# Resubmit a range:
#   sbatch --array=<A>-<B> ~/RP/Code/DAIC/main_multidata/submit_main_multidata.sh

#SBATCH --job-name=main_md_%a
...
#SBATCH --output=/home/nfs/pvarelabernal/RP/Code/DAIC/main_multidata/slurm_%A_%a.out
#SBATCH --error=/home/nfs/pvarelabernal/RP/Code/DAIC/main_multidata/slurm_%A_%a.err
...
EXP_DIR="$STUDENT_DIR/experiments/runs/main_multidata/$FAMILY/$RUN_BASE/data_seed${DATA_SEED}/$RUN_ID"
