#!/bin/bash
#SBATCH --job-name=dinov3_3ch_imp_v1
...
#SBATCH --output=/home/nfs/pvarelabernal/RP/Code/DAIC/3ch/impeccable_v1/slurm_%j.out
#SBATCH --error=/home/nfs/pvarelabernal/RP/Code/DAIC/3ch/impeccable_v1/slurm_%j.err

set -euo pipefail

STUDENT_DIR=/tudelft.net/staff-bulk/ewi/insy/PRLab/Students/pvarelabernal
EXP_DIR=$STUDENT_DIR/experiments/runs/3ch/impeccable_v1
...
srun python -u training/train.py --config configs/dinov3_vits_2d5_3ch_impeccable_daic.yaml
