#!/bin/bash
# Full fine-tuning baseline: all backbone params unfrozen, 5ch input, seed 42.

#SBATCH --job-name=full_ft_5ch_s42
...
#SBATCH --output=/home/nfs/pvarelabernal/RP/Code/DAIC/full_ft/impeccable_neighbors5_stride5_patch_emb_full_ft/seed42_run01/slurm_%j.out
#SBATCH --error=/home/nfs/pvarelabernal/RP/Code/DAIC/full_ft/impeccable_neighbors5_stride5_patch_emb_full_ft/seed42_run01/slurm_%j.err

set -euo pipefail

STUDENT_DIR=/tudelft.net/staff-bulk/ewi/insy/PRLab/Students/pvarelabernal
EXP_DIR=$STUDENT_DIR/experiments/runs/full_ft/impeccable_neighbors5_stride5_patch_emb_full_ft/seed42_run01
CONFIG=configs/dinov3_vits_full_ft_5ch_impeccable_neighbors5_stride5_patch_emb_seed42_run01_daic.yaml
...
echo "=== Starting training (5ch full fine-tuning, seed42) ==="
