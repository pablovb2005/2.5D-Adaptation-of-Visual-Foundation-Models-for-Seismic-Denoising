#!/bin/bash
# Mechanism control: 3ch with shuffled neighbors during training (seed 43).

#SBATCH --job-name=3ch_shuf_s43_r02
...
#SBATCH --output=/home/nfs/pvarelabernal/RP/Code/DAIC/3ch_shuffled/impeccable_shuffled3_stride5_lora_r16/seed43_run02/slurm_%j.out
#SBATCH --error=/home/nfs/pvarelabernal/RP/Code/DAIC/3ch_shuffled/impeccable_shuffled3_stride5_lora_r16/seed43_run02/slurm_%j.err

set -euo pipefail

STUDENT_DIR=/tudelft.net/staff-bulk/ewi/insy/PRLab/Students/pvarelabernal
EXP_DIR=$STUDENT_DIR/experiments/runs/3ch_shuffled/impeccable_shuffled3_stride5_lora_r16/seed43_run02
CONFIG=configs/dinov3_vits_2d5_3ch_impeccable_shuffled3_stride5_lora_r16_seed43_run02_daic.yaml
...
echo "=== Starting training (3ch_shuffled seed43) ==="
