#!/bin/bash
# Batch F3 robustness evaluation for all main_multidata runs.
...
#
# Submit:
#   sbatch ~/RP/Code/DAIC/main_multidata/submit_main_f3_batch.sh

#SBATCH --job-name=main_f3_batch
...
#SBATCH --output=/home/nfs/pvarelabernal/RP/Code/DAIC/main_multidata/slurm_f3batch_%j.out
#SBATCH --error=/home/nfs/pvarelabernal/RP/Code/DAIC/main_multidata/slurm_f3batch_%j.err
